...
async fn test_udp_servers() -> io::Result<()> {
    ...
    let expected_addr_v4;
    let expected_addr_v6;
    if is_behind_nat {
        ...
        }).expect("Reference STUN must have an IPv4 address");
        ...
        resV6.set_port(0);
        expected_addr_v6 = Some(resV6);
    } else {
        expected_addr_v4 = None;
        expected_addr_v6 = None;
    }
